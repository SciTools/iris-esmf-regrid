...
def test_esmpy_normalisation():
    ...
    result_dstarea = regridder.regrid(src_array, norm_type=Constants.Method.DSTAREA)
    ...
    result_fracarea = regridder.regrid(src_array, norm_type=Constants.Method.FRACAREA)
